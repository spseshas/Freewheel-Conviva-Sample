...
#if !TARGET_OS_TV
@class FWOMSDKFriendlyObstructionConfiguration;
#endif
...
#if !TARGET_OS_TV
/**
	Add the friendly obstruction configuration of a view which should be excluded from all ad session viewability calculations for Open Measurement SDK. This method will have no effect if called after the ad session has finished.
 
	@param obstructionConfiguration to be excluded from all ad session viewability calculations.  See `FWOMSDKFriendlyObstructionConfiguration`.
 */
...
/**
	...
	@param obstructionConfiguration to be removed from the list of registered friendly obstruction configurations. See `FWOMSDKFriendlyObstructionConfiguration`.
 */
...
#if !TARGET_OS_TV
/**
	Return all potential friendly obstruction configurations added by the renderer in the playback lifecycle.
 
	- Note: This method will be called immediately after the renderer transits to `FWRendererStateStarted`. The renderer should instantiate all the views it might ever add in the ad playback lifecycle. Failure to do so might result in OMSDK reporting the ad as not viewed by the user. See `FWOMSDKFriendlyObstructionConfiguration`.
 */
