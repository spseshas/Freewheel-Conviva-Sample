...
/**
	Enumeration for OMSDK friendly obstruction types.
 */
typedef NS_ENUM(NSUInteger, FWOMSDKFriendlyObstructionType) {
	/**
		Friendly obstruction type in OMSDK Extension: media controls.
	 */
	FWOMSDKFriendlyObstructionMediaControls,

	/**
		Friendly obstruction type in OMSDK Extension: close ad.
	 */
	FWOMSDKFriendlyObstructionCloseAd,

	/**
		Friendly obstruction type in OMSDK Extension: not visible.
	 */
	FWOMSDKFriendlyObstructionNotVisible,

	/**
		Friendly obstruction type in OMSDK Extension: other.
	 */
	FWOMSDKFriendlyObstructionOther,
};
...
/**
	Ad event: ad loaded. Ad has loaded.

	See: `FWAdEventNotification`
*/
FW_EXTERN NSString *const FWAdLoadedEvent;
...
/**
	...
	- Note:
		- For AdManager to automatically retrieve GDPR regulations, this parameter should be set before initializing FWRequestConfiguration. If the value needs to be set after initializing FWRequestConfiguration, please assign FWRequestConfiguration's consentConfiguration to a new FWConsentConfiguration object. Changes made to consentConfiguration after an AdRequest calls submitWithTimeout will be ignored.
		- GDPR consent information can also be manually set using FWGDPRConsentConfiguration.
		- Values will be set to nil if they are not an instance of NSString or an instance of a class that inherits from NSString.
...
/**
	...
	- Note:
		- For AdManager to automatically retrieve the GDPR consent string, this parameter should be set before initializing FWRequestConfiguration. If the value needs to be set after initializing FWRequestConfiguration, please assign FWRequestConfiguration's consentConfiguration to a new FWConsentConfiguration object. Changes made to consentConfiguration after an AdRequest calls submitWithTimeout will be ignored.
		- GDPR consent information can also be manually set using FWGDPRConsentConfiguration.
		- Values will be set to nil if they are not an instance of NSString or an instance of a class that inherits from NSString.
	- See:
		- `[FWRequestConfiguration setConsentConfiguration:]`
...
/**
	Parameter: Used to set the disclosures made and choices selected by a user regarding consumer data privacy in association with CCPA. This key should be set in [NSUserDefaults standardUserDefaults].

	Valid values: NSString representing the US privacy string.

	Default value: `nil`

	- Note:
		- For AdManager to automatically retrieve the US privacy string, this parameter should be set before initializing FWRequestConfiguration. If the value needs to be set after initializing FWRequestConfiguration, please assign FWRequestConfiguration's consentConfiguration to a new FWConsentConfiguration object. Changes made to consentConfiguration after an AdRequest calls submitWithTimeout will be ignored.
		- Values will be set to nil if they are not an instance of NSString or an instance of a class that inherits from NSString.
	- See:
		- `[FWRequestConfiguration setConsentConfiguration:]`
		- `[FWAdRequest submitWithTimeout:]`
